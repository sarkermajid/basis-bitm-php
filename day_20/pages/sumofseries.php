        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card bg-dark text-white fw-bold">
                    <div class="card-header text-center fw-bold display-6 text-info">Sum Of Series</div>
                    <div class="card-body">
                        <form action="action.php" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" value="Make Result" class="btn btn-outline-info w-100" name="sum_series_btn">
                                </div>
                            </div>
                        </form>
                    </div>
